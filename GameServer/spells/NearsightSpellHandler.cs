	...
	public class NearsightSpellHandler : ImmunityEffectSpellHandler
	{
		...
		public override IList<string> DelveInfo
		{
			get
			{
                ...
                if (Spell.Value != 0)
                    list.Add(LanguageMgr.GetTranslation((Caster as GamePlayer).Client, "DelveInfo.Value", (int)Spell.Value) + "%");
                ...
                if (Spell.Duration >= ushort.MaxValue * 1000)
                    ...
                    list.Add(LanguageMgr.GetTranslation((Caster as GamePlayer).Client, "DelveInfo.Duration") + Spell.Duration/60000 + ":" + (Spell.Duration%60000/1000).ToString("00") + " min");
