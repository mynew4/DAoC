...
// WHRIA bard song
                            if (index < innerList.Count)
                                index = innerList.FindIndex(index + 1, e => (e.Item1 is Spell) && ((Spell)e.Item1).NeedInstrument && (e.Item2 is SpellLine) && ((SpellLine)e.Item2).Spec == sl.Key.Spec);
// END WHRIA
				...
				if (requiredLevel <= Level)
				{
					...
					if (reactiveEffectLine != null)
					{
						if (reactiveItem.ProcSpellID != 0)
						{
							...
							if (spell != null)
							{
                                int chance = reactiveItem.ProcChance > 0 ? reactiveItem.ProcChance : ServerProperties.Properties.PROC_CHANCE;
...
// WHRIA
                double advantage=0;
                if (this.CharacterClass.ID == 1) advantage=ServerProperties.Properties.CLASS1;
                if (this.CharacterClass.ID == 2) advantage=ServerProperties.Properties.CLASS2;
                if (this.CharacterClass.ID == 3) advantage=ServerProperties.Properties.CLASS3;
                if (this.CharacterClass.ID == 4) advantage=ServerProperties.Properties.CLASS4;
                if (this.CharacterClass.ID == 5) advantage=ServerProperties.Properties.CLASS5;
                if (this.CharacterClass.ID == 6) advantage=ServerProperties.Properties.CLASS6;
                if (this.CharacterClass.ID == 7) advantage=ServerProperties.Properties.CLASS7;
                if (this.CharacterClass.ID == 8) advantage=ServerProperties.Properties.CLASS8;
                if (this.CharacterClass.ID == 9) advantage=ServerProperties.Properties.CLASS9;
                if (this.CharacterClass.ID == 10) advantage=ServerProperties.Properties.CLASS10;
                if (this.CharacterClass.ID == 11) advantage=ServerProperties.Properties.CLASS11;
                if (this.CharacterClass.ID == 12) advantage=ServerProperties.Properties.CLASS12;
                if (this.CharacterClass.ID == 13) advantage=ServerProperties.Properties.CLASS13;
                if (this.CharacterClass.ID == 14) advantage=ServerProperties.Properties.CLASS14;
                if (this.CharacterClass.ID == 15) advantage=ServerProperties.Properties.CLASS15;
                if (this.CharacterClass.ID == 16) advantage=ServerProperties.Properties.CLASS16;
                if (this.CharacterClass.ID == 17) advantage=ServerProperties.Properties.CLASS17;
                if (this.CharacterClass.ID == 18) advantage=ServerProperties.Properties.CLASS18;
                if (this.CharacterClass.ID == 19) advantage=ServerProperties.Properties.CLASS19;
                if (this.CharacterClass.ID == 20) advantage=ServerProperties.Properties.CLASS20;
                if (this.CharacterClass.ID == 21) advantage=ServerProperties.Properties.CLASS21;
                if (this.CharacterClass.ID == 22) advantage=ServerProperties.Properties.CLASS22;
                if (this.CharacterClass.ID == 23) advantage=ServerProperties.Properties.CLASS23;
                if (this.CharacterClass.ID == 24) advantage=ServerProperties.Properties.CLASS24;
                if (this.CharacterClass.ID == 25) advantage=ServerProperties.Properties.CLASS25;
                if (this.CharacterClass.ID == 26) advantage=ServerProperties.Properties.CLASS26;
                if (this.CharacterClass.ID == 27) advantage=ServerProperties.Properties.CLASS27;
                if (this.CharacterClass.ID == 28) advantage=ServerProperties.Properties.CLASS28;
                if (this.CharacterClass.ID == 29) advantage=ServerProperties.Properties.CLASS29;
                if (this.CharacterClass.ID == 30) advantage=ServerProperties.Properties.CLASS30;
                if (this.CharacterClass.ID == 31) advantage=ServerProperties.Properties.CLASS31;
                if (this.CharacterClass.ID == 32) advantage=ServerProperties.Properties.CLASS32;
                if (this.CharacterClass.ID == 33) advantage=ServerProperties.Properties.CLASS33;
                if (this.CharacterClass.ID == 34) advantage=ServerProperties.Properties.CLASS34;
                if (this.CharacterClass.ID == 35) advantage=ServerProperties.Properties.CLASS35;
                if (this.CharacterClass.ID == 36) advantage=ServerProperties.Properties.CLASS36;
                if (this.CharacterClass.ID == 37) advantage=ServerProperties.Properties.CLASS37;
                if (this.CharacterClass.ID == 38) advantage=ServerProperties.Properties.CLASS38;
                if (this.CharacterClass.ID == 39) advantage=ServerProperties.Properties.CLASS39;
                if (this.CharacterClass.ID == 40) advantage=ServerProperties.Properties.CLASS40;
                if (this.CharacterClass.ID == 41) advantage=ServerProperties.Properties.CLASS41;
                if (this.CharacterClass.ID == 42) advantage=ServerProperties.Properties.CLASS42;
                if (this.CharacterClass.ID == 43) advantage=ServerProperties.Properties.CLASS43;
                if (this.CharacterClass.ID == 44) advantage=ServerProperties.Properties.CLASS44;
                if (this.CharacterClass.ID == 45) advantage=ServerProperties.Properties.CLASS45;
                if (this.CharacterClass.ID == 46) advantage=ServerProperties.Properties.CLASS46;
                if (this.CharacterClass.ID == 47) advantage=ServerProperties.Properties.CLASS47;
                if (this.CharacterClass.ID == 48) advantage=ServerProperties.Properties.CLASS48;
                if (this.CharacterClass.ID == 49) advantage=ServerProperties.Properties.CLASS49;
                if (this.CharacterClass.ID == 50) advantage=ServerProperties.Properties.CLASS50;
                if (this.CharacterClass.ID == 51) advantage=ServerProperties.Properties.CLASS51;
                if (this.CharacterClass.ID == 52) advantage=ServerProperties.Properties.CLASS52;
                if (this.CharacterClass.ID == 53) advantage=ServerProperties.Properties.CLASS53;
                if (this.CharacterClass.ID == 54) advantage=ServerProperties.Properties.CLASS54;
                if (this.CharacterClass.ID == 55) advantage=ServerProperties.Properties.CLASS55;
                if (this.CharacterClass.ID == 56) advantage=ServerProperties.Properties.CLASS56;
                if (this.CharacterClass.ID == 57) advantage=ServerProperties.Properties.CLASS57;
                if (this.CharacterClass.ID == 58) advantage=ServerProperties.Properties.CLASS58;
                if (this.CharacterClass.ID == 59) advantage=ServerProperties.Properties.CLASS59;
                if (this.CharacterClass.ID == 60) advantage=ServerProperties.Properties.CLASS60;
                DPS = (int)((double)DPS * (1+ advantage));
// END                
...
// WHRIA CHANT
        public void DisableSkillKeepDelay(Skill skill)
        {
            if (this.Client.Account.PrivLevel > 1)
                return;

            var disables = new List<Tuple<Skill, int>>();
            disables.Add(new Tuple<Skill, int>(skill, 0));
...
//            if (slot < (int)eInventorySlot.FirstBagHorse || slot > (int)eInventorySlot.LastBagHorse || (ChampionLevel >= 5 && ActiveSaddleBags == (byte)eHorseSaddleBag.All))
                if (slot < (int)eInventorySlot.FirstBagHorse || slot > (int)eInventorySlot.LastBagHorse || ActiveSaddleBags == (byte)eHorseSaddleBag.All)
			{
				return true;
			}
...
// WHRIA
				...
				{
					if (slot < (int)eInventorySlot.FirstBagHorse + NUM_SLOTS_PER_SADDLEBAG)
					{
						return true;
					}
					else if (slot < (int)eInventorySlot.FirstBagHorse + NUM_SLOTS_PER_SADDLEBAG * 2)
					{
						return true;
					}
					else if (slot < (int)eInventorySlot.FirstBagHorse + NUM_SLOTS_PER_SADDLEBAG * 3)
					{
						return true;
					}
				}
...
// END
		...
		public virtual bool DropItem(eInventorySlot slot_pos, out WorldInventoryItem droppedItem)
		{
            ...
            if (this.Client.Account.PrivLevel != 1)
            {
                this.Out.SendMessage("GM cannot drop item on the ground", eChatType.CT_Loot, eChatLoc.CL_SystemWindow);
                return false;
            }
            // END            
...
// WHRIA
//          Out.SendMessage("CraftedItemID : "+itemID.ToString(), eChatType.CT_System, eChatLoc.CL_SystemWindow);
            bool bBug = false;

            // WHRIA safe easy craft
            
            double multifplier = 0.1;
            if (Realm == eRealm.Albion) multifplier = ServerProperties.Properties.CRAFT_EASY_MULTIFLIER_ALB;
            else if (Realm == eRealm.Midgard) multifplier = ServerProperties.Properties.CRAFT_EASY_MULTIFLIER_MID;
            else if (Realm == eRealm.Hibernia) multifplier = ServerProperties.Properties.CRAFT_EASY_MULTIFLIER_HIB;
...
// END
			if (recipe != null)
			{
                ...
                if (rawMaterials.Count == 0 && itemToCraft!=null)
                {
                    string temp_Id_nb = "";

                    if (itemToCraft.Level > 50) temp_Id_nb = "whria_object_50";
                    else temp_Id_nb = "whria_object_40";

                    temp_Id_nb += "_" + itemToCraft.Object_Type;

                    rawMaterials = GameServer.Database.SelectObjects<DBCraftedXItem>("`CraftedItemId_nb` = '" + temp_Id_nb + "'");

                    if (rawMaterials.Count==0)
                    {
                        if (Realm == eRealm.Albion) temp_Id_nb += "_1";
                        if (Realm == eRealm.Midgard) temp_Id_nb += "_2";
                        if (Realm == eRealm.Hibernia) temp_Id_nb += "_3";
                ...
                {
                    if (rawMaterials[i].IngredientId_nb.Contains("arcanite_metal_bars") && (Realm == eRealm.Albion || Realm == eRealm.Midgard))
                    {
                        rawMaterials[i].IngredientId_nb = rawMaterials[i].IngredientId_nb.Replace("arcanite_metal_bars", "arcanium_metal_bars");
                    }
                    if (rawMaterials[i].IngredientId_nb.Contains("arcanium_metal_bars") && (Realm == eRealm.Hibernia))
                    {
                        rawMaterials[i].IngredientId_nb = rawMaterials[i].IngredientId_nb.Replace("arcanium_metal_bars", "arcanite_metal_bars");
                    }


                    bool bContain = false;
                    foreach (string ex in ServerProperties.Properties.CRAFT_WHITE_LIST.SplitCSV())
                    {
                        if (rawMaterials[i].IngredientId_nb.Contains(ex))
                        {
                            bContain = true; break;
                        }
                    }
                    ...
                    if (!bContain)
                    {
                        ItemTemplate template = GameServer.Database.FindObjectByKey<ItemTemplate>(rawMaterials[i].IngredientId_nb);

                        if (template==null)
                        {
                            rawMaterials[i].IngredientId_nb = "whria_gold";
                            continue;
                        }

                        if (template.Price * rawMaterials[i].Count > 10000)
                        {
                            int imoney = (int)(template.Price * rawMaterials[i].Count / 10000);
                            if (imoney <= 0) imoney = 1;

                            if (imoney > 1000 * multifplier) imoney = (int)(1000 * multifplier);

                            rawMaterials[i].IngredientId_nb = "whria_gold";
                            rawMaterials[i].Count = imoney;
                        }
                        else
                        {
                            int imoney = (int)(template.Price * rawMaterials[i].Count / 100);
                            if (imoney <= 0) imoney = 1;

                            rawMaterials[i].IngredientId_nb = "whria_silver";
                            rawMaterials[i].Count = imoney;
                        }
                    }
                }
            ...
            if (bBug)
            {
                if (recipe != null)
                {
                    if (GetCurrentMoney() > 10000 * GetCraftingSkillValue((eCraftingSkill)recipe.CraftingSkillType) * multifplier)
                    {
                        RemoveMoney(10000 * GetCraftingSkillValue((eCraftingSkill)recipe.CraftingSkillType) * (long)multifplier);
                        GainCraftingSkill((eCraftingSkill)recipe.CraftingSkillType, 10);
                        Out.SendMessage("Easy craft by WHRIA", eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    }
                    else
                    {
                        Out.SendMessage("You dont have enough money. : " + recipe.Id_nb, eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    }
                }
                else 
                {
                    if (GetCurrentMoney() > 10000 * 1000 * (long)multifplier)
                    {
                        RemoveMoney(10000 * 1000 * (long)multifplier);


                        GainCraftingSkill((eCraftingSkill)1, 1);
                        GainCraftingSkill((eCraftingSkill)2, 1);
                        GainCraftingSkill((eCraftingSkill)3, 1);
                        GainCraftingSkill((eCraftingSkill)4, 1);
                        GainCraftingSkill((eCraftingSkill)5, 1);
                        GainCraftingSkill((eCraftingSkill)6, 1);
                        GainCraftingSkill((eCraftingSkill)7, 1);
                        GainCraftingSkill((eCraftingSkill)8, 1);
                        GainCraftingSkill((eCraftingSkill)9, 1);
                        GainCraftingSkill((eCraftingSkill)10, 1);
                        GainCraftingSkill((eCraftingSkill)11, 1);
                        GainCraftingSkill((eCraftingSkill)12, 1);
                        GainCraftingSkill((eCraftingSkill)13, 1);
                        GainCraftingSkill((eCraftingSkill)14, 1);
                        GainCraftingSkill((eCraftingSkill)15, 1);
                        Out.SendMessage("Easy craft by WHRIA", eChatType.CT_System, eChatLoc.CL_SystemWindow);
                    }
                    else
                    {
