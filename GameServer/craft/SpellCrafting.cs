...
// WHRIA
            if (player.TradeWindow.TradeItems.Count > 4)
            {
...
// WHRIA
                        else if (item.Bonus5Type == 0)
                        {
                            item.Bonus5Type = gem.Bonus1Type;
                            item.Bonus5 = gem.Bonus1;
                        }
                        else if (item.Bonus6Type == 0)
                        {
                            item.Bonus6Type = gem.Bonus1Type;
                            item.Bonus6 = gem.Bonus1;
                        }
                        else if (item.Bonus7Type == 0)
                        {
                            item.Bonus7Type = gem.Bonus1Type;
                            item.Bonus7 = gem.Bonus1;
                        }
                        else if (item.Bonus8Type == 0)
                        {
                            item.Bonus8Type = gem.Bonus1Type;
                            item.Bonus8 = gem.Bonus1;
                        }
// END
