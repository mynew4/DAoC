...
namespace DOL.GS.Keeps
{
	...
	public class GameKeepDoor : GameLiving, IDoor, IKeepItem
	{
		...
		public virtual void LoadFromPosition(DBKeepPosition pos, GameKeepComponent component)
		{
			...
			{
                // WHRIA
                log.Error("Failed to load keep door from position! DoorID=" + m_doorID + ". keepposition.TemplateID=" + m_templateID + ". Component SkinID=" + component.Skin + ". KeepID=" + component.AbstractKeep.KeepID);
			}
