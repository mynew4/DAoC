...
namespace DOL.GS
{
    ...
    public class ML10BossMob : GameNPC // on indique ici que le mob fera partie des GameNPC classic
    {
        ...
        Style revenge = SkillBase.GetStyleByID(RevengeID, RevengeClassID);

        private static int ThorID = 172;
        private static int ThorClassID = 22;
        Style thor = SkillBase.GetStyleByID(ThorID, ThorClassID);
        ...
        public int dmgmulti = 1; // Variable pour la multiplication des dommages engendr?par le mob
        public int dmgmulti_org = 1; // Variable pour la multiplication des dommages engendr?par le mob
...
//                            Console.WriteLine("BackStyle");
                    ...
                    else //we can not do back style.. we can not do side style.. !
                    {
                        ...
                        {
//                            Console.WriteLine(this.Name + " WALTTO");
...
namespace DOL.AI.Brain
{
    ...
    /// </summary>
    public class ML10BossMobBrain : StandardMobBrain
    {
        ...
        private void CastWhria(int iChance)
        {
            if (!Body.IsStunned)
            {
                if (Util.Chance(iChance))
        ...
        public void AddAggroListTo(ML10BossMobBrain brain)
        {
