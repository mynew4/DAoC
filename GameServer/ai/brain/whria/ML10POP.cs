...
namespace DOL.AI.Brain
{
    ...
    public class ML10POPMob1Brain : APlayerVicinityBrain
    {
        ...
        public override void Think()
        {
            ...
            {
                MOB.Model = 1733; // je decrit pas car ca tu connais
                MOB.Size = 150;
                MOB.Level = 57;
                ...
                MOB.ChangeBaseStat(eStat.CON, 50);
                MOB.ChangeBaseStat(eStat.STR, 30);
                MOB.ChangeBaseStat(eStat.DEX, 100);
                MOB.ChangeBaseStat(eStat.QUI, 70);
