				...
				else
				{
					...
					for (int i = firstSlot; i < (firstSlot + 10); i++)
					{
						...
						else
						{
                            ...
                            {
                                string stringValue = Char.ConvertFromUtf32(97 + i - firstSlot);
                                stringValue = "slot" + stringValue + m_gameClient.Account.Name;
                                stringValue = stringValue.Replace("0", "a");
                                stringValue = stringValue.Replace("1", "b");
                                stringValue = stringValue.Replace("2", "c");
                                stringValue = stringValue.Replace("3", "d");
                                stringValue = stringValue.Replace("4", "e");
                                stringValue = stringValue.Replace("5", "f");
                                stringValue = stringValue.Replace("6", "g");
                                stringValue = stringValue.Replace("7", "h");
                                stringValue = stringValue.Replace("8", "i");
                                stringValue = stringValue.Replace("9", "j");
                                pak.FillString(stringValue, 24);
                            }
                            // END
                            ...
                            // WHRIA START
                            if (!nameCheck.IsMatch(c.Name))
                                locationDescription = "[" + c.Name + "]" + locationDescription;
                            // END
